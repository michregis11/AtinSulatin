...
import BAYBAYIN1 from '../images/toTraceScripts/BAYBAYIN_OU1.png';
import BAYBAYIN2 from '../images/toTraceScripts/BAYBAYIN_OU2.png';


//import Blue_BAYBAYIN1 from '../images/toTraceScripts/Blue/Blue_BAYBAYIN_OU1.png';
import Blue_BAYBAYIN2 from '../images/toTraceScripts/Blue/Blue_BAYBAYIN_OU2.png';

//import Red_BAYBAYIN1 from '../images/toTraceScripts/Red/Red_BAYBAYIN_OU1.png';
import Red_BAYBAYIN2 from '../images/toTraceScripts/Red/Red_BAYBAYIN_OU2.png';

//import Yellow_BAYBAYIN1 from '../images/toTraceScripts/Yellow/Yellow_BAYBAYIN_OU1.png';
import Yellow_BAYBAYIN2 from '../images/toTraceScripts/Yellow/Yellow_BAYBAYIN_OU2.png';

import TRACED from '../images/tracedScripts/TRACED_OU.png';
import Blue_TRACED from '../images/tracedScripts/traced_Blue/Blue_TRACED_OU.png';
import Red_TRACED from '../images/tracedScripts/traced_Red/Red_TRACED_OU.png';
import Yellow_TRACED from '../images/tracedScripts/traced_Yellow/Yellow_TRACED_OU.png';
...
import RNSketchCanvas from '@terrylinla/react-native-sketch-canvas';4
...
class TracingOUScreen extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={style.backView}>
                ...
                {/* <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.16, left: screenWidth * 0.47}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.20, left: screenWidth * 0.565}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.37, left: screenWidth * 0.575}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.45, left: screenWidth * 0.52}]}>
                </View> */}
                ...
                */}
                ...
                {/* <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.55, left: screenWidth * 0.59}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.70, left: screenWidth * 0.595}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.83, left: screenWidth * 0.52}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.83, left: screenWidth * 0.44}]}>
                </View> */}
...
export default withNavigation(TracingOUScreen);