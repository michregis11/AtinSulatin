...
import BAYBAYIN1 from '../images/toTraceScripts/BAYBAYIN_DA.png';
import BAYBAYIN2 from '../images/toTraceScripts/BAYBAYIN_DA2.png';
//import Blue_BAYBAYIN1 from '../images/toTraceScripts/Blue/Blue_BAYBAYIN_DA1.png';
import Blue_BAYBAYIN2 from '../images/toTraceScripts/Blue/Blue_BAYBAYIN_DA2.png';

//import Red_BAYBAYIN1 from '../images/toTraceScripts/Red/Red_BAYBAYIN_DA1.png';
import Red_BAYBAYIN2 from '../images/toTraceScripts/Red/Red_BAYBAYIN_DA2.png';

//import Yellow_BAYBAYIN1 from '../images/toTraceScripts/Yellow/Yellow_BAYBAYIN_DA1.png';
import Yellow_BAYBAYIN2 from '../images/toTraceScripts/Yellow/Yellow_BAYBAYIN_DA2.png';

import TRACED from '../images/tracedScripts/TRACED_DA.png';
import Blue_TRACED from '../images/tracedScripts/traced_Blue/Blue_TRACED_DA.png';
import Red_TRACED from '../images/tracedScripts/traced_Red/Red_TRACED_DA.png';
import Yellow_TRACED from '../images/tracedScripts/traced_Yellow/Yellow_TRACED_DA.png';
...
class TracingDAScreen extends React.Component {
        ...
        if(!this.state.traced) {
            if(this.state.dot4) {
                ...
                if(this.state.dot9) {
                    ...
                    this.setState({toTrace: tracedColorFirst[this.colorIndex], dot6: false, dot5: false, dot7: false, 
                        dot9: false, dot8: false,});
                }
            } else {
                this.clearBoard();
            }
    ...
    clearBoard = () => {
        this.setState({dot1: false, dot2: false, dot3: false, dot4: false, dot5: false, 
            dot6: false, dot7: false, dot8: false, dot9: false, traced: false,
            toTrace: BAYBAYIN1});
    ...
    render() {
        ...
        return (
            <View style={style.backView}>
                ...
                {/* <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.30, left: screenWidth * 0.28}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.34, left: screenWidth * 0.38}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.245, left: screenWidth * 0.58}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.265, left: screenWidth * 0.70}]}>
                </View> */}
                ...
                */}
                ...
                {/* <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.45, left: screenWidth * 0.285}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.70, left: screenWidth * 0.285}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.76, left: screenWidth * 0.39}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.67, left: screenWidth * 0.58}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.68, left: screenWidth * 0.70}]}>
                </View> */}
...
export default withNavigation(TracingDAScreen);