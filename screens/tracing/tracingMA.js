...
import BAYBAYIN1 from '../images/toTraceScripts/BAYBAYIN_MA.png';
import BAYBAYIN2 from '../images/toTraceScripts/BAYBAYIN_MA2.png';


//import Blue_BAYBAYIN1 from '../images/toTraceScripts/Blue/Blue_BAYBAYIN_MA1.png';
import Blue_BAYBAYIN2 from '../images/toTraceScripts/Blue/Blue_BAYBAYIN_MA2.png';

//import Red_BAYBAYIN1 from '../images/toTraceScripts/Red/Red_BAYBAYIN_MA1.png';
import Red_BAYBAYIN2 from '../images/toTraceScripts/Red/Red_BAYBAYIN_MA2.png';

//import Yellow_BAYBAYIN1 from '../images/toTraceScripts/Yellow/Yellow_BAYBAYIN_MA1.png';
import Yellow_BAYBAYIN2 from '../images/toTraceScripts/Yellow/Yellow_BAYBAYIN_MA2.png';

import TRACED from '../images/tracedScripts/TRACED_MA.png';
import Blue_TRACED from '../images/tracedScripts/traced_Blue/Blue_TRACED_MA.png';
import Red_TRACED from '../images/tracedScripts/traced_Red/Red_TRACED_MA.png';
import Yellow_TRACED from '../images/tracedScripts/traced_Yellow/Yellow_TRACED_MA.png';
...
class TracingMAScreen extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={style.backView}>
                ...
                {/* <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.32, left: screenWidth * 0.27}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.37, left: screenWidth * 0.335}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.65, left: screenWidth * 0.325}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.825, left: screenWidth * 0.37}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.62, left: screenWidth * 0.51}]}>
                </View>
                <View style={[style.dot, {position: 'absolute', top: screenHeight * 0.37, left: screenWidth * 0.585}]}>
                </View>
...
export default withNavigation(TracingMAScreen);