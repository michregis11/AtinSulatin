...
import BB_B from '../../images/planeScripts/BB_B.png';
import BB_K from '../../images/planeScripts/BB_K.png';
import BB_D from '../../images/planeScripts/BB_D.png';
import BB_G from '../../images/planeScripts/BB_G.png';
import BB_H from '../../images/planeScripts/BB_H.png';
import BB_L from '../../images/planeScripts/BB_L.png';
import BB_M from '../../images/planeScripts/BB_M.png';
import BB_N from '../../images/planeScripts/BB_N.png';
import BB_NG from '../../images/planeScripts/BB_NG.png';
import BB_P from '../../images/planeScripts/BB_P.png';
import BB_S from '../../images/planeScripts/BB_S.png';
import BB_T from '../../images/planeScripts/BB_T.png';
import BB_W from '../../images/planeScripts/BB_W.png';
import BB_Y from '../../images/planeScripts/BB_Y.png';
...
const toAnswerList = [BB_B, BB_K, BB_D, BB_G, BB_H, BB_L, BB_M, BB_N,
    BB_NG, BB_P, BB_S, BB_T, BB_W, BB_Y, BB_BEI, BB_BOU, BB_KEI, BB_KOU, BB_DEI, BB_DOU, BB_GEI, BB_GOU, BB_HEI, BB_HOU, BB_LEI, BB_LOU, 
    BB_MEI, BB_MOU, BB_NEI, BB_NOU, BB_NGEI, BB_NGOU, BB_PEI, BB_POU, BB_SEI, BB_SOU, BB_TEI, BB_TOU, BB_WEI, BB_WOU,
    BB_YEI, BB_YOU,  ];

import script_B from '../../images/planeScripts/script_B.png';
import script_K from '../../images/planeScripts/script_K.png';
import script_D from '../../images/planeScripts/script_D.png';
import script_G from '../../images/planeScripts/script_G.png';
import script_H from '../../images/planeScripts/script_H.png';
import script_L from '../../images/planeScripts/script_L.png';
import script_M from '../../images/planeScripts/script_M.png';
import script_N from '../../images/planeScripts/script_N.png';
import script_NG from '../../images/planeScripts/script_NG.png';
import script_P from '../../images/planeScripts/script_P.png';
import script_S from '../../images/planeScripts/script_S.png';
import script_T from '../../images/planeScripts/script_T.png';
import script_W from '../../images/planeScripts/script_W.png';
import script_Y from '../../images/planeScripts/script_Y.png';
...
const romanList = [script_B, script_K, script_D, script_G, script_H, script_L, script_M, script_N,
    script_NG, script_P, script_S, script_T, script_W, script_Y, script_BEI, script_BOU, script_KEI, script_KOU, script_DEI, script_DOU, script_GEI, script_GOU, script_HEI, script_HOU, script_LEI, script_LOU, 
...
class ScriptLevelTwo extends React.Component {
        ...
        realm.write(()=> {
            if(!GameData[0]) {
                ...
                if(GameData[0].language == 'Filipino') {
                    this.finishedTenMessage = 'Natapos mo ang pangalawang lebel ng pagbaybay.\nMaaring subukan ulit.';
                    this.lostMessage = 'Nakatatlong maling sagot kana. Huwag magalala, maaring subukan ulit!';
                } else if(GameData[0].language == 'English') {
                    this.finishedTenMessage ='You have finished the level 2 script quiz set.\nYou can try again';
            ...
            <View style={{position: 'absolute', width: '100%', height: '100%'}}>
                ...
                <View style={style.scriptQuizView}>
                    <View style={{ width: '80%', height: '75%', }}>
                        <Image source={this.state.toAnswerScript} style={{
                            position: 'absolute',
                            top: '5%',
                            left: '5%',
                            width: '90%',
...
export default withNavigation(ScriptLevelTwo);