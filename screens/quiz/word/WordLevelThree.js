...
const toAnswerList = [bb_isa, bb_dalawa, bb_tatlo, bb_apat, bb_lima, bb_anim, bb_pito,
    bb_walo, bb_siyam, bb_sampu, bb_ahas, bb_alimango, bb_aso, bb_baboy, bb_baka, bb_bibe, bb_buwaya,
...
const romanList = [word_isa, word_dalawa, word_tatlo, word_apat, word_lima, word_anim, word_pito,
    word_walo, word_siyam, word_sampu, word_ahas, word_alimango, word_aso, word_baboy, word_baka, word_bibe, word_buwaya,
...
class WordLevelThree extends React.Component {
        ...
        realm.write(()=> {
            if(!GameData[0]) {
                ...
                if(GameData[0].language == 'Filipino') {
                    this.finishedTenMessage = 'Natapos mo na ang pangatlong baitang ng pagbasa.\nMaaring subukan ulit.';
                    this.lostMessage = 'Nakatatlong maling sagot kana. Huwag magalala, maaring subukan ulit!';
                } else if(GameData[0].language == 'English') {
                    this.finishedTenMessage ='You have finished the level 3 word quiz set.\nYou can try again';
    ...
    answerPickPressed = (pickNumber) => {
        ...
        if(this.correct) {
            realm.write(()=> {
                GameData[0].pesoCoin = GameData[0].pesoCoin + 3;
                GameData[0].coinEarned = GameData[0].coinEarned + 3;
                    ...
                    <View style={style.answerScriptList}>
                        <TouchableOpacity style={[style.answerScriptContainer, {left: '-10%'}]} onPress={()=>{
                            ...
                            <Animatable.View style={{width: '100%', height: '100%',}} animation={this.state.tada}>
                                ...
                                <View style={style.answerScript}>
                                    <Image source={this.state.answerScript1} style={style.image}>
                                    </Image>
                                </View>
                            </Animatable.View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={style.answerScriptContainer} onPress={()=>{
                            ...
                            <Animatable.View style={{width: '100%', height: '100%'}} animation={this.state.tada2}>
                                ...
                                <View style={style.answerScript}>
                                    <Image source={this.state.answerScript2} style={style.image}>
                                    </Image>
                                </View>
                            </Animatable.View>
                        ...
                        <TouchableOpacity style={[style.answerScriptContainer, {right: '-10%'}]} onPress={()=>{
                            ...
                            <Animatable.View style={{width: '100%', height: '100%'}} animation={this.state.tada3}>
                                ...
                                <View style={style.answerScript}>
                                    <Image source={this.state.answerScript3} style={style.image}>
                                    </Image>
                                </View>
                            </Animatable.View>
...
export default withNavigation(WordLevelThree);